...
const WORLD_CUP_DATA = {
  ...
  broadcasters: [
    ...
    { id: "jiocinema", name: "JioCinema", countries: ["IN"], type: "free", price: "Free Streaming (Ad-supported)", medium: ["Web", "App"], link: "https://www.jiocinema.com", languages: ["English", "Hindi", "Bengali", "Malayalam", "Tamil"], coverage: "Full 104 matches live streaming for free in India.", logoColor: "#d946ef" },
    { id: "sports18", name: "Sports18", countries: ["IN"], type: "paid", price: "Paid Pay-TV (Low Cost)", medium: ["TV"], link: "https://www.sports18.com", languages: ["English", "Hindi"], coverage: "Television broadcasts of all matches live.", logoColor: "#1e3a8a" },
